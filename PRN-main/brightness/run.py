...
def run():
    ...
    parser.add_argument('--result_save_path', type=str, default='../result1')
    ...
    if args.test:
        ...
        model.cuda()
        dataloader = DataLoader(Dataset(args.data_root, args.mask_root, args.mask_mode, args.target_size, mask_reverse = True), batch_size = args.batch_size, shuffle =False, num_workers = args.n_threads)
